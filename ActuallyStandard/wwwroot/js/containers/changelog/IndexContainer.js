...
function fetchReleases() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("/api/changelog")];
                case 1:
                    response = _a.sent();
...
var IndexContainer = /** @class */ (function (_super) {
    ...
    IndexContainer.prototype.componentWillMount = function () {
        var _this = this;
        this.setState({ releases: [] });
        fetchReleases().then(function (releases) {
            _this.setState(function (state) { return (__assign({}, state, { releases: releases })); });
        });
    };
    IndexContainer.prototype.render = function () {
        return React.createElement(Index, __assign({}, this.state));
    };
    return IndexContainer;
}(React.PureComponent));
export { IndexContainer };
//# sourceMappingURL=IndexContainer.js.map